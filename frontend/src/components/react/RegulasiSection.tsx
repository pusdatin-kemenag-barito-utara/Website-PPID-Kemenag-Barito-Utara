...
import { Scroll, FileText, Search, Tag, Eye } from "lucide-react";
...
export default function RegulasiSection() {
  ...
  useEffect(() => {
    ...
    apiGet<{ items?: RegulasiItem[] }>("/regulasi")
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-3 text-[11px] text-muted-foreground pt-1">
                      <span>Dipublish: {item.tgl_terbit}</span>
                      <span>•</span>
                      <span>Ukuran File: {item.ukuran}</span>
                    </div>
                  </div>
                </div>
                {item.file_url ? (
