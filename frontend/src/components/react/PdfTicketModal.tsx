...
export default function PdfTicketModal({ isOpen, onClose, ticketData }: PdfTicketModalProps) {
	...
	return (
		<div className="fixed inset-0 z-[10000] bg-black/70 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in">
			<div className="bg-background border border-border/80 rounded-3xl max-w-xl w-full p-6 md:p-8 space-y-6 shadow-2xl relative overflow-hidden animate-in zoom-in-95">
				...
				<div
					id="printable-ticket"
					className="bg-white text-black p-6 rounded-2xl border border-gray-200 space-y-6 shadow-inner font-sans"
				>
						...
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-[9px] text-gray-500">
									Jl. A. Yani No. 85, Muara Teweh, Barito Utara, Kalteng
								</p>
							</div>
						</div>
					...
					<div className="space-y-3 text-xs">
						<div className="grid grid-cols-3 border-b border-gray-100 pb-2">
							...
							<span className="col-span-2 font-extrabold text-gray-900">
								{ticketData.namaPemohon}
							</span>
						</div>
						<div className="grid grid-cols-3 border-b border-gray-100 pb-2">
						...
						<div className="grid grid-cols-3 border-b border-gray-100 pb-2">
							...
							<span className="col-span-2 font-bold text-gray-800">
								{ticketData.tglPengajuan}
							</span>
						</div>
						<div className="grid grid-cols-3 border-b border-gray-100 pb-2">
							<span className="font-bold text-gray-500">Status Awal Tiket</span>
							<span className="col-span-2 font-extrabold text-[#007144]">
								{ticketData.status}
							</span>
						</div>
						<div className="grid grid-cols-3 pt-1">
							<span className="font-bold text-gray-500">Rincian Informasi</span>
							<span className="col-span-2 font-medium text-gray-700 leading-snug">
								{ticketData.rincianInformasi}
							</span>
						</div>
					</div>
