...
export const profilData: ProfilData = {
	sejarah:
		'Pejabat Pengelola Informasi dan Dokumentasi (PPID) Kementerian Agama Kabupaten Barito Utara dibentuk berdasarkan amanat Undang-Undang Nomor 14 Tahun 2008 tentang Keterbukaan Informasi Publik (KIP). PPID berkomitmen menyediakan layanan informasi yang transparan, efisien, akuntabel, dan mudah diakses oleh seluruh lapisan masyarakat.',
